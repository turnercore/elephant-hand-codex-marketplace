...
Apply the Iron Law format from `../../references/brooks/common.md`. Each risk in `../../references/brooks/decay-risks.md` has its own Severity
...
Use the standard Report Template from `../../references/brooks/common.md`.
Mode: PR Review
