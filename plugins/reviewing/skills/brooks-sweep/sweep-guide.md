...
1a. Apply Auto Scope Detection from `../../references/brooks/common.md` if the user did not
...
`../../references/brooks/decay-risks.md`.
...
in `../../references/brooks/test-decay-risks.md`.
...
defined in `../../references/brooks/decay-risks.md` Risk 5 — use that checklist. Step 5
...
`../../references/brooks/common.md` with these additions:
