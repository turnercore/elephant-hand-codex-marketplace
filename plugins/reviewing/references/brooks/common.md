...
from the `references/brooks/` directory for loading and scanning instructions.
...
`remedy-guide.md` from the `references/brooks/` directory before writing the report.
